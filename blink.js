...
class Blink extends Entity
{
    ...
    handleWhatToDoWhenAttacking()
    {
        ...
        if (this.basicAttack && !this.isJumpAttacking())
        {
            ...
            if ((this.dashSlashFaceRight.currentFrame() === 1 || this.dashSlashFaceRight.currentFrame() === 2) ||
                this.dashSlashFaceLeft.currentFrame() === 1 || this.dashSlashFaceLeft.currentFrame() === 2)
            {
