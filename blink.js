...
class Blink extends Entity {
            ...
            if (!this.basicAttack) {
                ...
                if (!this.facingRight) {
                    ...
                    this.jumpFaceRightAnimation.drawFrame(
                        this.game.blinksClockTick,
                        ctx,
                        this.x - 50, // adjust jump 50 pixels when facing right. Improves look/feel.
                        this.y
                    );
                }
            }
    ...
    update() {
        ...
        // Assign damage sound effect randomly for next play()
        ...
        // Clear platforms array if necessary
    ...
    handleCollison(other, type) {
        ...
        if (other instanceof Portal && type === "damage") {
            ...
            var teleport =
                teleportSounds[Randomizer.returnRandomInt(teleportSounds.length)];
            teleport.play();
        ...
        if (other instanceof Platform && type !== "attack") {
            ...
            if (this.y < other.y - other.frameHeight) {
                if (!this.myPlatforms.includes(other)) {
                    ...
                    if (this.level == 2) {
                        width = 0;
                    } else if (this.level == 3 || this.level == 1 || this.level == 2 || this.level == 4) {
                        width = other.width;
                    }
                ...
                this.platformY =
                    ...
                    this.frameHeight;
                if (this.level == 3 || this.level == 1 || this.level == 2 || this.level == 4) {
                    this.platformY += 45;
                }
