...
class Entity {
  ...
  constructor(game, x, y) {
    ...
    this.enemyInjuredSoundEffect.volume = 0.5;
    this.enemyInjuredSoundEffect1.volume = 0.5;
    this.enemyInjuredSoundEffect2.volume = 0.5;
    this.enemyInjuredSoundEffect3.volume = 0.5;
    this.enemyInjuredSoundEffect4.volume = 0.5;
    this.enemyInjuredSoundEffect5.volume = 0.5;
    this.enemyInjuredSoundEffect6.volume = 0.5;
    ...
    this.enemyDeathSoundEffect1.volume = 0.5;
    this.enemyDeathSoundEffect2.volume = 0.5;
    this.enemyDeathSoundEffect3.volume = 0.5;
    this.enemyDeathSoundEffect4.volume = 0.5;
    this.enemyDeathSoundEffect5.volume = 0.5;
    ...
    this.myInjuredSound = this.injuredSounds[
      Randomizer.returnRandomInt(this.injuredSounds.length)
    ];
    this.myDeathSound = this.deathSounds[
      Randomizer.returnRandomInt(this.deathSounds.length)
    ];
  }
