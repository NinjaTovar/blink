...
class Entity {
  ...
  constructor(game, x, y) {
    ...
    this.necromanInjuredSoundEffect = document.getElementById(
      "necromanInjured"
    );
    this.violatorInjured = document.getElementById("violatorInjured");
    this.guyHurtSoundEffect1.volume = 0.5;
    this.flyHurtSoundEffect.volume = 0.5;
    this.guyHurtSoundEffect2.volume = 0.5;
    this.mummyHurtSoundEffect.volume = 0.5;
    this.necromanInjuredSoundEffect.volume = 0.5;
    this.violatorInjured.volume = 0.5;
    ...
    this.flyDeathSoundEffect.volume = 0.5;
    this.necromanDeathSoundEffect.volume = 0.5;
    this.violatorDeathSoundEffect.volume = 0.5;
    this.bugDeathSoundEffect.volume = 0.5;
    this.mummyDeathSoundEffect.volume = 0.5;
        ...
        if (this.game.blink.facingRight) {
          if (!(this instanceof Blink)) {
            ...
            if (!(this instanceof Fireball)) {
              if (
                this.myInjuredSound != null ||
                this.myInjuredSound != undefined
              ) {
