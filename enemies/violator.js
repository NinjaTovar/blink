...
class Violator
{
    ...
    draw(ctx)
    {
        ...
        {
            this.swingRightAnimation.drawFrame(this.game.clockTick, ctx, this.x, this.y)
        }
        // If field "isHeadingRight" is false, play fly left animation
        else if ((!this.isHeadingRight && !this.willRewind()))
        {
            this.swingLeftAnimation.drawFrame(this.game.clockTick, ctx, this.x, this.y)
        }
        ...
        if (this.isHeadingRight && this.willRewind() && this.myPath.length > 1)
        {
            ...
            this.swingRightAnimation.drawFrame(this.game.clockTick, ctx, this.x,
                this.y);
        ...
        {
            this.x = this.myPath.pop();
            this.swingLeftAnimation.drawFrame(this.game.clockTick, ctx, this.x,
                this.y);
